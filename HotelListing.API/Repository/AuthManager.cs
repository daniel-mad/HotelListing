...
namespace HotelListing.API.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        private string _loginProvider = "HotelListingApi";
        ...
        public async Task<AuthResponseDto> Login(LoginDto loginDto)
        {
            ...
            var isValidPassword = await _userManager.CheckPasswordAsync(_user, loginDto.Password);

            if (_user == null || isValidPassword == false)
            {
                return null;
            }
